...
public class SessionFrame extends JFrame {
	...
	public static JButton game1JoinButton, game2JoinButton, game3JoinButton, openClosedButton1, openClosedButton2,
			openClosedButton3;
	...
	public SessionFrame() {
		...
		// turn off resizability, set close operation, turn off decoration, and set
		// title of window
